...
// ANSWER:
// No the solution requires a for loop which gives at best, O(n) time complexity
...
// 7) -------------------------------------------------------
let numbersOne = [76,35,73,13,4,88,23,12,86,1,54,9,10,2]
// remember numbers could be reassigned, added to, etc.
let newNumbersA = numbersOne.filter((num) => {
  return num < 5
})
...
let newNumbersB = numbersOne.map((num) => {
  return num * 3
})
...
// 9) -------------------------------------------------------
function removeNum() {
    numbersOne.splice(3,1)
}
// Q: What is the time complexity of the function?
// ANSWER:
// Again O(n) because you are performing one function call to the array

// 10) -------------------------------------------------------
function insertNum() {
    numbersOne.splice(3, 0, 19)
}
// Q: What is the time complexity of the function?
// ANSWER:
//O(n)
...
// Q: What is the time complexity of the function?
// ANSWER:
//O(1) pushing one value to an array
...
// ANSWER:
//It is not possible to improve this functions space complexity
...
// ANSWER: 
//countLetters: Is O(n) because it is necesarry to execute a for loop which has complexity of O(n)
//countLettersRoundTwo: Same as above because you still have to use the same amount memory resource space to get the job done